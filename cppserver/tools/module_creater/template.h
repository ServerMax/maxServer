...
\n\
set({module_name}\n\
    \"${PROJECT_SOURCE_DIR}/logic/module/{module_name}/header.h\"\n\
    \"${PROJECT_SOURCE_DIR}/logic/module/{module_name}/{module_name}.h\"\n\
    \"${PROJECT_SOURCE_DIR}/logic/module/{module_name}/{module_name}.cpp\"\n\
    \"${PROJECT_SOURCE_DIR}/logic/module/{module_name}/main.cpp\"\n\
)\n\
\n\
