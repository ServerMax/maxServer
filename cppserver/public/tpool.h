...
#ifdef _DEBUG
        T * create_object(const char * file, const s32 line) {
...
#ifdef _DEBUG
        T * create_object(const char * file, const s32 line, Args... args) {
            chunk * chunk = create(file, line);
#else
...
#ifdef _DEBUG
        void recover_object(T * t, const char * file, const s32 line) {
